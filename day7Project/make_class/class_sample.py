...
# 파이썬은 객체지향 스크립트 언어이다
# 절차지향 프로그래밍 가능함 : 실행코드 구문이 작성된 순서대로 작동됨
...
print('ref1이 참조하는 객체 안의 score 필드 값 : ', ref1.score)
# print('ref2이 참조하는 객체 안의 score 필드 값 : ', ref2.score)   # error
